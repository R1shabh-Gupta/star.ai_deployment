...
const SearchEngineCard = () => {
  ...
  return (
    <div className="h-3/4 bg-gray-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-40 border border-gray-100 max-w-4xl w-5xl mx-auto flex">
      {/* filter */}

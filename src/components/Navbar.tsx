    ...
    <>
      <nav className="flex justify-between py-2 px-10 items-center bg-slate-50 bg-opacity-20 dark:bg-[#0a0a0b]">
        <div className="flex items-center justify-center">
          {/* <img src={myGif} alt="my-gif" className="h-8" /> */}
          <video className="h-10" src={logoVid} autoPlay loop muted />
          <h1 className="text-2xl ml-[-13px] font-bold bg-gradient-to-r from-sky-400 to-blue-500 dark:bg-gradient-to-r dark:from-white dark:via-sky-500 dark:to-sky-500 bg-clip-text text-transparent">
            tar.AI
          </h1>
        </div>
